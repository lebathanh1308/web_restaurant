...
if(isset($_POST['submit'])){
	...
	//Code for Insertion
	$query=mysqli_query($con,"INSERT INTO tblbookings(bookingNo,fullName,emailId,phoneNumber,bookingDate,bookingTime,noAdults,noChildrens) values('$bno','$fname','$emailid','$phonenumber','$bookingDateFormatted','$bookingtime','$noadults','$nochildrens')");
	if($query){
